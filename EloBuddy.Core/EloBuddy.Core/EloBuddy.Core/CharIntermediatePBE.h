...
namespace EloBuddy
{
	namespace Native
	{
		...
		{
		public:
			MAKE_GET( FlatCooldownMod, float, 0x004 );
			...
			MAKE_GET( FlatMagicPenetrationMod, float, 0x0AC );
			MAKE_GET( PercentMagicPenetrationMod, float, 0x0B4 );
			...
			MAKE_GET( FlatCritChanceMod, float, 0x0D4 );
			MAKE_GET( FlatCritDamageMod, float, 0x0D8 );
			MAKE_GET( PercentCritDamageMod, float, 0x0DC );
			MAKE_GET( FlatPhysicalDamageMod, float, 0x0E0 PADDING );
			MAKE_GET( PercentPhysicalDamageMod, float, 0x0E4 PADDING );
			MAKE_GET( FlatMagicDamageMod, float, 0x0E8 PADDING );
			...
			MAKE_GET( AttackSpeedMod, float, 0x144 );
			MAKE_GET( BaseAttackDamage, float, 0x148 );
			MAKE_GET( FlatBaseAttackDamageMod, float, 0x150 );
			MAKE_GET( PercentBaseAttackDamageMod, float, 0x154 );
			MAKE_GET( BaseAbilityDamage, float, 0x158 );
			...
			MAKE_GET( Armor, float, 0x170 );
			MAKE_GET( SpellBlock, float, 0x174 );
			MAKE_GET( BaseHPRegenRate, float, 0x178 );
			MAKE_GET( HPRegenRate, float, 0x17C );
			MAKE_GET( BasePARRegenRate, float, 0x180 );
			MAKE_GET( PercentBasePARRegenMod, float, 0x184 );
			MAKE_GET( PARRegenRate, float, 0x188 );
			MAKE_GET( MoveSpeed, float, 0x18C );
			MAKE_GET( AttackRange, float, 0x190 );
			MAKE_GET( CastRange, float, 0x194 );
