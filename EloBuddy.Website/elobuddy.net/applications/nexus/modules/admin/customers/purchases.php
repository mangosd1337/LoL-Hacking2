...
class _purchases extends \IPS\Dispatcher\Controller
{
	...
	protected function transfer()
	{
		...
		if ( $this->purchase->billing_agreement )
		{
			\IPS\Output::i()->error( 'not_with_grouped', '2X195/G', 403, '' );
		}
	...
	public function renew()
	{
		...
		if ( $this->purchase->billing_agreement )
		{
			\IPS\Output::i()->error( 'not_with_grouped', '2X195/D', 403, '' );
		}
	...
	protected function cancel()
	{
		...
		if ( $this->purchase->billing_agreement )
		{
			\IPS\Output::i()->error( 'not_with_grouped', '2X195/H', 403, '' );
		}
	...
	protected function reactivate()
	{
		...
		if ( $this->purchase->billing_agreement )
		{
			\IPS\Output::i()->error( 'not_with_grouped', '2X195/I', 403, '' );
		}
	...
	protected function delete()
	{
		...
		if ( $this->purchase->billing_agreement )
		{
			\IPS\Output::i()->error( 'not_with_grouped', '2X195/J', 403, '' );
		}
	...
	protected function group()
	{
		...
		if ( $this->purchase->billing_agreement )
		{
			\IPS\Output::i()->error( 'not_with_grouped', '2X195/E', 403, '' );
		}
	...
	protected function ungroup()
	{
		...
		if ( $this->purchase->billing_agreement )
		{
			\IPS\Output::i()->error( 'not_with_grouped', '2X195/F', 403, '' );
		}
