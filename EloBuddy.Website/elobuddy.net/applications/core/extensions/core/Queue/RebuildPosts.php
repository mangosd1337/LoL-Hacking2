...
class _RebuildPosts
{
	...
	public function run( &$data, $offset )
	{
		...
		foreach( $iterator as $item )
		{
			...
			{
				/* If the last rebuild cycle timed out, currentRebuild might be set and we might have already rebuilt this post (the post that caused the rebuild to fail might come after this).
